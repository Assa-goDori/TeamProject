            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12">
                    ...
                    <c:if test="${!empty sessionScope.loginmem}">
                    	${sessionScope.loginmem.member_name}님 반갑습니다.&nbsp;|&nbsp; <a style="color: white;" href="${path}/member/logout.dog">로그아웃</a>&nbsp;|&nbsp;<a href="${path}/member/memberMypage.dog?id=${sessionScope.loginmem.member_id}" style="color: white;">마이페이지</a>
                    </c:if>
