...
public interface AdminMapper {
	...
	@Select("select m.member_id, m.member_tel, m.member_email, m.file1, m.member_auth, s.shelter_name, s.shelter_address,s.shelter_no from member m, shelter s where m.shelter_no=s.shelter_no and member_type=1")
