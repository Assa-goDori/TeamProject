...
public interface BuylistMapper {
	...
	@Insert("insert into buylist (buy_no,member_id,buy_date,buy_state,buy_postcode,buy_address,buy_daddress) values(#{buy_no},#{member_id}, now(),'배송중',#{buy_postcode},#{buy_address},#{buy_daddress})")
