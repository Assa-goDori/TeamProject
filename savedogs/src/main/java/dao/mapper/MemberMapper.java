...
public interface MemberMapper {
	...
	@Insert("insert into member "
			+ "(member_id, member_name, shelter_no, member_pass, member_email, member_tel, del_tf, member_type, file1, file2, member_auth)"
			+ " values (#{member_id}, #{member_name}, #{shelter_no}, #{member_pass}, #{member_email}, #{member_tel}, true, 1, #{file1}, #{file2}, 1)")
