...
public class MemberLoginAspect {
	...
	public Object I_M_LoginCheck(ProceedingJoinPoint joinPoint,HttpSession session) throws Throwable{
	...
	public Object C_M_LoginCheck(ProceedingJoinPoint joinPoint,HttpSession session) throws Throwable{
		Member loginmem = (Member)session.getAttribute("loginmem");
		if(loginmem == null) {
			throw new LoginException("로그인 후 거래하세요","../member/login.dog");
		}
